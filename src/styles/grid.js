...
export const Container = styled.div `
  ...
  @media ${device.sm} { max-width: ${props => props.smMaxWidth ? props.smMaxWidth : '540px'}; }
  @media ${device.md} { max-width: ${props => props.mdMaxWidth ? props.mdMaxWidth : '720px'}; }
  @media ${device.lg} { max-width: ${props => props.lgMaxWidth ? props.lgMaxWidth : '960px'}; }
  @media ${device.xl} { max-width: ${props => props.xlMaxWidth ? props.xlMaxWidth : '1140px'}; }
`
